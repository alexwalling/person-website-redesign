      ...
      <div className="App">
        <div className="body">
          ...
          <div className="container">
            <NavLink to="/about-me"><h3 className="">About Me</h3></NavLink>
            <NavLink to="/projects"><h3 className="">Projects</h3></NavLink>
            <NavLink to="/job-history"><h3 className="">Job History</h3></NavLink>
          </div>
        */}
        </div>
      </div>
